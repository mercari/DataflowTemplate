...
public class Max implements Sequencer {
    ...
    public List<String> validate() {
        ...
        if(this.name == null) {
            errorMessages.add("sequencer:Max.name must not be null.");
        }
        if(this.field == null) {
            errorMessages.add("sequencer:Max.field must not be null.");
        }
    ...
    public <T> void execute(
        ...
        if(fieldValue_ == null || stateValue_ == null) {
            ...
            updateValue = fieldValue_.compareTo(stateValue_) > 0 ? fieldValue_ : stateValue_;
        }
